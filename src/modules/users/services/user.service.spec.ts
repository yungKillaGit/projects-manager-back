...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    ...
    it('should save users with encrypted password', async () => {
      const userInput = {
        name: user.name,
        username: user.username,
        password: 'plain-password',
    ...
    it('should return serialized users', async () => {
  ...
  describe('findById', () => {
    ...
    it('should find users from DB using given id', async () => {
  ...
  describe('getUserById', () => {
    ...
    it('throw not found exception if users is not found', async () => {
  ...
  describe('validateUsernamePassword', () => {
    ...
    it('should return  users  when credentials are valid', async () => {
      jest
        .spyOn(mockedRepository, 'findOne')
        .mockImplementation(async () => user);
  ...
  describe('findByUsername', () => {
    ...
    it('should find users from DB using given username', async () => {
  ...
  describe('updateUser', () => {
    ...
    it('should throw not found exception if users not found', async () => {
      const userId = 1;
      const input: UpdateUserInput = {
        name: 'Test',
        password: 'updated-password',
